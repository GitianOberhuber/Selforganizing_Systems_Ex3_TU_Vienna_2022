...
class MiniSom(object):
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5,
                 ...
                 activation_distance='euclidean', random_seed=None, lookuptable=None,
                 mnemonic_shape = None):
        ...
        neig_functions = {'gaussian': self._gaussian,
                          ...
                          'lookup': self._lookuptable_distance}
        ...
        if neighborhood_function == 'lookup' and lookuptable is None:
            raise ValueError("When lookup neighborhood-function is selected a lookup table must be provided"
                             "(as lookuptable parameter)!")
        ...
        distance_functions = {'euclidean': self._euclidean_distance,
                              ...
                              'manhattan_mnemonic': self._manhattan_distance_mnemonic,
        ...
        if distance_functions == 'manhattan_mnemonic' and mnemonic_shape is None:
            raise ValueError("When manhattan_mnemonic distance-function is selected a mnemonic shape must be provided"
                             "(as mnemonic_shape parameter)!")
